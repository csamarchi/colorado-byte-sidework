  ...
  return (
    <div className="about-us-container">
      <div className="about-text-container">
        ...
        <p>We empower enterprises to future-proof their business and disrupt their industry.</p>
      </div>
      ...
      <div id="entrepeneurship-container">
        <div id="entrepeneurship-text">
          ...
          <p>We help our customers to accelerate their business. 
          <br/>
          Our team consists of members born and bred 
          <br/> 
          in the startup community with capabilities to
          <br/> 
          scale large without scaling staff.</p>
          <p> Although we have extensive experience in <br/> 
          large corporate IT and IT infrastructure, <br/> 
          the paradigm of slow and expensive technological change runs 
          <br/>
          counter to our core philosophies.</p>
        </div>
      </div>
